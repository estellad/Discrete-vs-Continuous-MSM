...
# TODO: separate analysis for df_init_allvar into female and male
...
dmodp0m <- polr(Dtrt ~ #Dtrtp + 
                  gccumdosescale + timebasis_epi, data=Dtrtp0dat, 
                control = list(maxit = 2000, trace = 1, REPORT=1))
summary(dmodp0m)                   
...
dmodpnot0m <- polr(Dtrt ~ Dtrtp + 
                     gccumdosescale + timebasis_epi, data=Dtrtpnot0dat, 
                   control = list(maxit = 2000, trace = 1, REPORT=1))
summary(dmodpnot0m)                   
