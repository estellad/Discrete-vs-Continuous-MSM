...
# #### Helper Functions ####
source("C:/Users/dongy30/Desktop/Marginal_Sim-master/Z_10_X_01/Sim2/Marginal_sim2.R") 
...
#outpath <- 'C:/Users/dongy30/Desktop/Results/Scenario2/CTM'
...
sim <- function(no) { # sim for each core
  ...
  #### Helper Functions ####
  source("Marginal_sim2.R") 
  source("helper_sim2.R")
  source("estfun-glm.q")
...
round(results, 3)
write.table(round(results, 3), file=file.path(outpath, 'CTM_1000_results_sim2'))
