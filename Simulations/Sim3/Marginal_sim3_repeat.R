...
# #### Helper Functions ####
source("C:/Users/dongy30/Desktop/Marginal_Sim-master/Z_10_X_01/Sim3/Marginal_sim3.R") 
...
outpath <- 'C:/Users/dongy30/Desktop/Results/Scenario3/CTM'
...
sim <- function(no) { # sim for each core
  ...
  #### Helper Functions ####
  source("Marginal_sim3.R") 
  source("helper_sim3.R")
  source("estfun-glm.q")
