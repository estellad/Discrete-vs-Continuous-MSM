...
marginalnew_one_round <- function(seed, m, nobs, states, trates, tlim){
  ...
  cbout_poi_ctm <- glm(Yevent ~ timebasis_cb + Aexpo + timebasisa_cb + offset(log(futime))
  ...
  cbout_unweight_ctm <- glm(Yevent ~ timebasis_cb + Aexpo + timebasisa_cb + offset(log(futime))
