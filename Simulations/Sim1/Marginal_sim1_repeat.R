...
# #### Helper Functions ####
source("C:/Users/dongy30/Desktop/Marginal_Sim-master/Z_X_01/Sim1/Marginal_sim1.R") 
...
#outpath <- 'C:/Users/dongy30/Desktop/Results/Scenario1/CTM'
...
setwd("C:/Users/dongy30/Desktop/Marginal_Sim-master/Z_X_01/Sim1")
###### Per simulation specification of st, ss ######

sim <- function(no) { # sim for each core
  
  #### Helper Functions ####
  source("Marginal_sim1.R") 
  source("helper_sim1.R")
  source("estfun-glm.q")
...
######### Only CB ##############
pointestall <- pointestall[, 4:6]
varestall <- varestall[, 4:6]
coverageall <- coverageall[, 4:6]
powerall <- powerall[, 4:6]
m<-3
...
results <- cbind(colMeans(pointestall),
                 ...
                 sqrt(colMeans(varestall)),                          # Mean SE
...
round(results, 3)
write.table(round(results, 3), file=file.path(outpath, 'CTM_1000_results_sim1'))
