...
# #### Helper Functions ####
source("C:/Users/dongy30/Desktop/Marginal_Sim-master/Z_X_01/Sim1/Marginal_sim1_slm.R") 
...
outpath <- 'C:/Users/dongy30/Desktop/Results/Scenario1/SLM'
#outpath <- 'C:/Users/dongy30/Desktop/Marginal_Sim-master/Z_X_01/CTM_1000_sub_cores'
...
numexposure <- 2 # logi_weighted, unweighted
...
sim <- function(no) { # sim for each core
  ...
  #### Helper Functions ####
  source("Marginal_sim1_slm.R") 
  source("helper_sim1_slm.R")
  source("estfun-glm.q")
...
round(results, 3)
write.table(round(results, 3), file=file.path(outpath, 'SLM_1000_results_sim1'))
